...
--
-- Name: increment_ad_stats_daily(bigint, date, bigint, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.increment_ad_stats_daily(p_ad_id bigint, p_date date, p_impressions bigint DEFAULT 0, p_clicks bigint DEFAULT 0) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: increment_article_stats_daily(bigint, date, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.increment_article_stats_daily(p_article_id bigint, p_date date, p_views bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: increment_article_views(bigint, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.increment_article_views(p_id bigint, p_count bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: increment_page_stats_daily(date, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.increment_page_stats_daily(p_date date, p_page_views bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
